...
public class Hot100_43_buildTree {
    public static void main(String[] args) {
        int[] preorder = {3,9,20,15,7};
        int[] inorder = {9,3,15,20,7};
        Hot100_43_buildTree solution = new Hot100_43_buildTree();
        TreeNode root = solution.buildTree1(preorder, inorder);
